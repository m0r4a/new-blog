...
!!! note
    I started writing all my notes here but this isn't my notetaking place, this is just my journal, so I moved everything into the [notes](https://blog.gmora.work/notes/concepts/IPAM/) section. (You will be redirected to the IPAM section because that's the first note at the time I'm writing this.
...
- [Masquerade (SNAT)](https://blog.gmora.work/notes/concepts/Masquerade%20(SNAT)/)
- 
